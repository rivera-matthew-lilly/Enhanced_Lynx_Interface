...
from PlateClasses import NormPlate, QuantPlate_Octet
...
if octetPlateCount >= 1:
    quantPlate1 = QuantPlate_Octet("QuantPlate1", octetFilePath1, numberOfQuads_fromOctetPlate1)
...
if octetPlateCount >= 2:
    quantPlate2 = QuantPlate_Octet("QuantPlate2", octetFilePath2,numberOfQuads_fromOctetPlate2)
...
if octetPlateCount >=3:
    quantPlate3 = QuantPlate_Octet("QuantPlate3", octetFilePath3, numberOfQuads_fromOctetPlate3)
